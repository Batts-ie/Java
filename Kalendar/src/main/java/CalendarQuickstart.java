...
public class CalendarQuickstart {
    ...
    public ArrayList GetFeiertage(String maxdate,String cal) throws IOException, GeneralSecurityException
    {
        ...
        DateTime maxDate = convertLocalTime(LocalDate.parse(maxdate));
        ...
        Events events = service.events().list(cal)
