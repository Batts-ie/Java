 ...
 */
package jollyday.jollyday.src.test.java.de.jollyday.util;
...
public class ClassLoadingUtilTest {
	...
	public void testGetClassloader() {
		assertSame("Expected the current threads classloader.", Thread.currentThread().getContextClassLoader(),
